...
export function configureExpressApp(indexUrl: string, publicPath: string, sendFileProxy?: SendFileProxyFunc, middleware?: (app: express.Express) => express.Express | void): express.Express & { port: Promise<number> } {
